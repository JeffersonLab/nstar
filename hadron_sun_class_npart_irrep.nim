...
import hadron_sun_class_npart_irrep_op, cgc_su3, cgc_irrep_mom, hashes

## #----------------------------------------------------------------------------
# Time slice collection of operators projected onto a definite irrep and specific row
type
  KeyHadronSUNClassNPartIrrep_t* = object
    ...
    Op*:          KeyHadronSUNClassNPartIrrepOp_t ## Operator
  

proc hash*(x: KeyHadronSUNClassNPartIrrep_t): Hash =
...
when isMainModule:
  ...
  var opsList: Table[string, KeyHadronSUNClassNPartIrrep_t]
